...
router.patch('/:movieId', applicationController.update)
router.delete('/:movieId', applicationController.delete)

router.get('/actors/index', actorController.index)
...
router.patch('/actors/:actorId', actorController.update)
router.delete('/actors/:actorId', actorController.delete)

router.get('/directors/index', directorController.index)
router.get('/directors/new', directorController.new)
router.post('/directors', directorController.create)
router.get('/directors/:directorId', directorController.show)
router.get('/directors/:directorId/edit', directorController.edit)
